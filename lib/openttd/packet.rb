module OpenTTD
    module Packet
        ...
        TCP_PAYLOAD_OPCODES = {
            ...
            7 => :tcp_server_need_game_password,
            ...
            #13 => :tcp_server_wait,
            #14 => :tcp_server_map,
            #15 => :tcp_client_map_ok,
            #16 => :tcp_server_join,
            #17 => :tcp_server_frame,
            #18 => :tcp_server_sync,
            #19 => :tcp_client_ack,
            #20 => :tcp_client_command,
            #21 => :tcp_server_command,
            #22 => :tcp_client_chat,
            #23 => :tcp_server_chat,
            #24 => :tcp_client_set_password,
            #25 => :tcp_client_set_name,
            #26 => :tcp_client_quit,
            #27 => :tcp_client_error,
            #28 => :tcp_server_quit,
            #29 => :tcp_server_error_quit,
            #30 => :tcp_server_shutdown,
