require 'openttd/payload/tcp_client'
require 'openttd/payload/tcp_server'
require 'openttd/payload/udp_client'
require 'openttd/payload/udp_server'
...
module OpenTTD
  ...
  module Payload
    ...
    CHAT_TYPE_ENCODING_MAP = {
      0 => :broadcast,
      1 => :team,
      2 => :private
    }

    CHAT_ACTION_ENCODING_MAP = {
      0 => :join,
      1 => :leave,
      2 => :server_message,
      3 => :chat,
